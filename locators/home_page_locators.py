...
class HomePageScooterLocators:
    ...
    QUESTIONS = [By.XPATH, ".//div[contains(@id,'accordion__heading')]"]  # Вопросы в блоке "Вопросы о важном" на главной странице
    ...
    LOGO_YANDEX = [By.XPATH, ".//img[@alt='Yandex']"]  # Логотип Самокат
